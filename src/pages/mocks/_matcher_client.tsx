...
import initialContent from "./__mocks__/feed";
// import initialData from "./code.json";
import initialData from "./__mocks__/feed.json";
...
export default function Page(): JSX.Element {
  ...
  return (
    <BrowserOnly fallback={<div>Mock Matcher Page</div>}>
      {() => (
        <Layout
          title="Mock Matcher Page"
          description="Tools for matching mocks to entities"
          noFooter
        >
          <EditorGroup />
        </Layout>
